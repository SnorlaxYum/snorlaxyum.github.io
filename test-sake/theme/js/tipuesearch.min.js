...
{out+='<td style="text-align:left;width:5ch"><a class="tipue_search_foot_box" id="'+(start-set.show)+'_'+replace+'">'+'⬅'+'</a></td>';}
if(page<=2)
...
{out+='';}}}
if(page+1!=pages)
{out+='<td style="text-align:right;width:5ch"><a class="tipue_search_foot_box" id="'+(start+set.show)+'_'+replace+'">'+'⮕'+'</a></td>';}
out+='</tr></table></div>';}}
else
